...
mod tests {
    ...
    /// What the queue, the live run, the logs, the failures, the inspector and
    /// the input inbox draw in their bodies before anything has happened; every other screen leaves its body
